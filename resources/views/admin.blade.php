...
<table width="100%" border="1" cellspacing="0">
    <tr>
        <th><p class='text-center'>№ конференции</p></th>
        <th><p class='text-center'>Дата</p></th>
        <th><p class='text-center'>Имя</p></th>
        <th><p class='text-center'>email</p></th>
        <th><p class='text-center'>Комментарий</p></th>
...
<table width="100%" border="1" cellpadding="4" cellspacing="0">
    <tr>
        ...
        <th><p class='text-center'>Ссылка на фото</p></th>
        <th><p class='text-center'>Название конференции</p></th>
        <th><p class='text-center'>Дата</p></th>
        <th><p class='text-center'>Место проведения</p></th>
        <th><p class='text-center'>Действие</p></th>
    </tr>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                ...
                                <div style="border='1'">
                                    ...
                                    <form method="post" action="{{route('admin_download')}}"
                                        ...
                                        <br>
                                        <input id="2" class="form-control" name="start_date" type="date"
                                               placeholder="Дата проведения">
                                        <br>
                                        <input id="3" class="form-control form-control-sm" name="location" type="text"
